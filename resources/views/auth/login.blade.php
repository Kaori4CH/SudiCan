    ...
    <div class="min-h-screen grid grid-cols-1 md:grid-cols-2">
        <div class="bg-[#556F50] flex flex-col justify-center items-center px-6 py-12 md:px-12 order-2 md:order-1">
            <div class="w-full max-w-sm">
                <h1 class="text-4xl md:text-5xl font-bold text-white text-center mb-8">Login</h1>
                ...
                <form action="{{ route('auth.authenticate') }}" method="POST" class="space-y-4">
                    ...
                    <div class="text-center pt-2">
                        <p class="text-xs md:text-sm text-gray-100">
                            ...
                            <a href="{{ route('auth.register') }}" class="text-blue-500 font-medium hover:underline ml-1">SignUp</a>
                        </p>
                    </div>
